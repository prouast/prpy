...
class ModelSaver(object):
  ...
  def __init__(self, dir="checkpoints", keep_best=5, keep_latest=1, save_optimizer=False, compare_fn=lambda x,y: x.score < y.score, sort_reverse=False, log_fn=logging.info):
    """Init the ModelSaver"""
  ...
  def save_keep(self, info, step, name):
  ...
  def save_latest(self, info, step, name):
  ...
  def save_best(self, info, score, step, name):
